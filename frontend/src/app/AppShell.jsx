  ...
  if (loading) {
    return (
      <div style={{
        ...
        <svg className="animate-spin" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--accent, #e8813a)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
